...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 container-responsive max-w-container text-center">
        <motion.div
        ...
        >
          ...
          >
            <span className="gradient-text-red">Transform</span>{' '}
            <span className="text-white">Your Body</span>
            <br />
            <span className="text-white">Transform</span>{' '}
            <span className="gradient-text-blue">Your Life</span>
          </motion.h1>
          ...
          >
            Join the elite community of fitness enthusiasts. Achieve your goals with world-class trainers and state-of-the-art facilities.
          </motion.p>
