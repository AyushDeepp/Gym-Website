...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-primary-darker pb-6 sm:pb-8 md:pb-12 px-4 sm:px-6 lg:px-8 pt-20 sm:pt-24 md:pt-28 lg:pt-32">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-sm sm:text-base text-gray-400">
            {isMember
              ? "Manage your membership and track your progress"
              ...
              {!isMember && (
                <div className="bg-primary-darker p-4 sm:p-6 rounded-lg border border-primary-lightGray">
                  ...
                  <p className="text-gray-400 text-sm sm:text-base mb-4">
                    Become a member to unlock exclusive features, access to all
                    programs, and personalized training.
                  </p>
                ...
                <div>
                  ...
                  <div className="bg-primary-darker p-4 sm:p-6 rounded-lg border border-primary-lightGray mb-4">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 gap-3">
                      ...
                      >
                        {membershipStatus?.membership?.status?.toUpperCase() ||
                          "INACTIVE"}
                      </span>
                    </div>
              ...
              <div className="bg-primary-darker p-4 sm:p-6 rounded-lg border border-primary-lightGray">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white text-sm sm:text-base font-semibold break-all">
                      {user.email}
                    </p>
                  </div>
                  <div>
